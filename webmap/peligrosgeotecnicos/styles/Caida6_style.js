var size = 0;
function categories_Caida6(feature, value) {
...
case 'Vuelco':
        ...
        image: new ol.style.Circle({radius: 3.6 + size,
            stroke: new ol.style.Stroke({color: 'rgba(136,160,167,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(43,131,186,1.0)'})})
                    ...
                    break;}};
var styleCache_Caida6={}
var style_Caida6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("TIPO_PELIG");
    var style = categories_Caida6(feature, value);
    var labelText = "";
    ...
    if (typeof clusteredFeatures !== "undefined") {
        ...
        if (!styleCache_Caida6[key]){
            ...
            styleCache_Caida6[key] = new ol.style.Style({"text": text})
        }
    } else {
        if ("" !== null) {
            labelText = String("");
    ...
    var allStyles = [styleCache_Caida6[key]];
